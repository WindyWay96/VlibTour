...
import vlibtour.vlibtour_tour_management.entity.TourDate;
...
public class VlibTourTourManagementBean implements VlibTourTourManagement {
	...
	@Override
	public String createTour(final int tourID, final String tourName, final String tourDescription, final String tourStatus) {
	...
	// Create a POI
		@SuppressWarnings("unchecked")
		@Override
	public String createPOI (final int poid, final String poiName, final String poiDescription,
